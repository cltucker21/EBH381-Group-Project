...
cat<<HERE >$1$2.ctl
      ...
      seqfile = /gpfs/scratch/cltucker/EBH381-Group-Project/$1.fas         * sequence data filename
      outfile = $1$2.txt   * main result file name
    ...
    fix_omega = 1      * 1:omega fixed, 0:omega to be estimated 
        omega = $4    * 1st fixed omega value [change this]

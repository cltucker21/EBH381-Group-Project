      ...
      seqfile = /gpfs/scratch/cltucker/EBH381-Group-Project/SIV_aligned_NEF.fas         * sequence data filename
      outfile = SIV_aligned_NEF0.10.txt   * main result file name
    ...
    fix_kappa = 1      * 1:kappa fixed, 0:kappa to be estimated
        kappa = 3.9824      * initial or fixed kappa

    fix_omega = 1      * 1:omega fixed, 0:omega to be estimated 
        omega = 0.10    * 1st fixed omega value [change this]

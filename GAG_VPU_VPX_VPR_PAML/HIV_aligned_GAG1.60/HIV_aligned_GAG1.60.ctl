      ...
      seqfile = /gpfs/scratch/cltucker/EBH381-Group-Project/HIV_aligned_GAG.fas         * sequence data filename
      outfile = HIV_aligned_GAG1.60.txt   * main result file name
    ...
    fix_kappa = 1      * 1:kappa fixed, 0:kappa to be estimated
        kappa = 4.4862      * initial or fixed kappa

    fix_omega = 1      * 1:omega fixed, 0:omega to be estimated 
        omega = 1.60    * 1st fixed omega value [change this]

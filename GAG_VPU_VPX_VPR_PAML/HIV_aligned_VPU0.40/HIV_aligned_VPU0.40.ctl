      ...
      seqfile = /gpfs/scratch/cltucker/EBH381-Group-Project/HIV_aligned_VPU.fas         * sequence data filename
      outfile = HIV_aligned_VPU0.40.txt   * main result file name
    ...
    fix_omega = 1      * 1:omega fixed, 0:omega to be estimated 
        omega = 0.40    * 1st fixed omega value [change this]

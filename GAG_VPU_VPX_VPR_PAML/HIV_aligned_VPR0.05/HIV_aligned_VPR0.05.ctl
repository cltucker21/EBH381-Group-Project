      ...
      seqfile = /gpfs/scratch/cltucker/EBH381-Group-Project/HIV_aligned_VPR.fas         * sequence data filename
      outfile = HIV_aligned_VPR0.05.txt   * main result file name
    ...
    fix_omega = 1      * 1:omega fixed, 0:omega to be estimated 
        omega = 0.05    * 1st fixed omega value [change this]
